...
```
    ...
    ##  $ replication_1: num [1:105, 1:105] 0 26 4 0 3 15 4 102 6 8 ...
    ##   ..- attr(*, "dimnames")=List of 2
    ##  $ replication_2: num [1:105, 1:105] 0 23 4 0 2 17 4 101 5 8 ...
    ##   ..- attr(*, "dimnames")=List of 2
...
```
    ...
    ##   ..$ replication_1: num [1:105, 1:105] 0 24 4 0 2 16 4 102 6 7 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ replication_2: num [1:105, 1:105] 0 23 4 0 3 17 4 101 6 8 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ replication_3: num [1:105, 1:105] 0 24 4 0 2 15 4 101 5 6 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ proba        : num [1:105, 1:105] 0.00 4.31e-05 2.16e-05 3.90e-06 1.81e-05 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##  $ parameter_2:List of 4
    ##   ..$ replication_1: num [1:105, 1:105] 0 53 2 0 0 39 1 77 5 8 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ replication_2: num [1:105, 1:105] 0 55 2 0 0 41 1 76 6 7 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ replication_3: num [1:105, 1:105] 0 53 2 0 0 40 1 76 5 7 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
...
```
    ...
    ##  [1,]    0   33    0    0    0  121    0    1    0     0
    ##  [2,]  568    0    0    0    0   23    0    0    0     0
...
```
    ...
    ## 1   parameter_1            0.05 replication_1 0.8156498 10.684697 0.12972747
    ## 2   parameter_1            0.05 replication_2 0.8155800 10.690061 0.13003115
    ## 3   parameter_1            0.05 replication_3 0.8157247 10.684989 0.12952762
    ## 4   parameter_2           0.055 replication_1 0.8308135  9.544019 0.11376563
    ## 5   parameter_2           0.055 replication_2 0.8307736  9.548657 0.11352463
    ## 6   parameter_2           0.055 replication_3 0.8307586  9.544693 0.11355070
    ## 7   parameter_3            0.06 replication_1 0.8430224  8.744316 0.09870019
    ## 8   parameter_3            0.06 replication_2 0.8430373  8.738878 0.09881899
    ## 9   parameter_3            0.06 replication_3 0.8432270  8.737343 0.09836767
    ## 10  parameter_4           0.065 replication_1 0.8514378  8.225334 0.08822688
    ## 11  parameter_4           0.065 replication_2 0.8512631  8.228431 0.08817867
    ## 12  parameter_4           0.065 replication_3 0.8514128  8.226626 0.08793026
    ## 13  parameter_5            0.07 replication_1 0.8549567  7.981397 0.08043973
    ## 14  parameter_5            0.07 replication_2 0.8550715  7.977962 0.08026996
    ## 15  parameter_5            0.07 replication_3 0.8550215  7.991106 0.08056190
    ## 16  parameter_6           0.075 replication_1 0.8554807  7.956501 0.08001765
    ## 17  parameter_6           0.075 replication_2 0.8553959  7.952704 0.07970821
    ## 18  parameter_6           0.075 replication_3 0.8555007  7.952423 0.07947129
    ## 19  parameter_7            0.08 replication_1 0.8548119  8.092382 0.07438489
    ## 20  parameter_7            0.08 replication_2 0.8547770  8.092301 0.07461016
    ## 21  parameter_7            0.08 replication_3 0.8548718  8.088970 0.07458179
    ## 22  parameter_8           0.085 replication_1 0.8530949  8.337377 0.07389807
    ## 23  parameter_8           0.085 replication_2 0.8531148  8.338529 0.07392419
    ## 24  parameter_8           0.085 replication_3 0.8531049  8.339982 0.07393695
    ## 25  parameter_9            0.09 replication_1 0.8499254  8.663048 0.07537339
    ## 26  parameter_9            0.09 replication_2 0.8499803  8.656542 0.07603004
    ## 27  parameter_9            0.09 replication_3 0.8499553  8.661487 0.07552007
    ## 28 parameter_10           0.095 replication_1 0.8463666  9.032051 0.08114319
    ## 29 parameter_10           0.095 replication_2 0.8465313  9.025917 0.08093574
    ## 30 parameter_10           0.095 replication_3 0.8464614  9.030871 0.08119252
    ## 31 parameter_11             0.1 replication_1 0.8425033  9.421231 0.08365216
    ## 32 parameter_11             0.1 replication_2 0.8424583  9.420163 0.08358598
    ## 33 parameter_11             0.1 replication_3 0.8424434  9.421498 0.08359432
    ##          CPL     CPC_d    KS_stat   KS_pval
    ## 1  0.6597684 0.8943134 0.07511468 0.9997305
    ## 2  0.6591189 0.8943982 0.07514462 0.9997284
    ## 3  0.6579596 0.8945130 0.07504979 0.9997350
    ## 4  0.6694279 0.9145582 0.05170529 1.0000000
    ## 5  0.6696035 0.9145183 0.05173524 1.0000000
    ## 6  0.6696035 0.9145932 0.05165039 1.0000000
    ## 7  0.6718834 0.9311594 0.03168503 1.0000000
    ## 8  0.6731444 0.9312643 0.03161016 1.0000000
    ## 9  0.6724278 0.9312193 0.03155525 1.0000000
    ## 10 0.6724768 0.9426245 0.03469980 1.0000000
    ## 11 0.6724866 0.9425946 0.03471976 1.0000000
    ## 12 0.6717300 0.9427743 0.03469480 1.0000000
    ## 13 0.6750292 0.9487938 0.03824365 1.0000000
    ## 14 0.6732731 0.9488288 0.03825363 1.0000000
    ## 15 0.6740589 0.9487539 0.03831353 1.0000000
    ## 16 0.6712782 0.9481899 0.04439298 1.0000000
    ## 17 0.6724812 0.9483097 0.04436802 1.0000000
    ## 18 0.6730885 0.9481500 0.04438799 1.0000000
    ## 19 0.6625387 0.9409325 0.05039756 1.0000000
    ## 20 0.6637771 0.9408826 0.05038259 1.0000000
    ## 21 0.6639876 0.9409974 0.05028775 1.0000000
    ## 22 0.6509704 0.9330112 0.05736547 1.0000000
    ## 23 0.6507634 0.9330312 0.05738544 1.0000000
    ## 24 0.6520496 0.9329413 0.05731556 1.0000000
    ## 25 0.6408840 0.9257688 0.06327023 0.9999988
    ## 26 0.6413255 0.9258087 0.06331016 0.9999988
    ## 27 0.6408840 0.9259235 0.06325026 0.9999989
    ## 28 0.6346472 0.9188208 0.06820666 0.9999911
    ## 29 0.6346472 0.9188807 0.06823162 0.9999910
    ## 30 0.6346472 0.9188857 0.06818670 0.9999911
    ## 31 0.6240271 0.9121025 0.07364223 0.9999458
    ## 32 0.6233503 0.9122123 0.07352743 0.9999477
    ## 33 0.6233942 0.9122023 0.07348251 0.9999484
