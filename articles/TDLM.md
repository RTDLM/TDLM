...
```
    ...
    ##  $ replication_1: num [1:105, 1:105] 0 25 4 0 3 15 4 101 6 7 ...
    ##   ..- attr(*, "dimnames")=List of 2
    ##  $ replication_2: num [1:105, 1:105] 0 23 4 0 2 17 4 101 5 6 ...
    ##   ..- attr(*, "dimnames")=List of 2
    ##  $ replication_3: num [1:105, 1:105] 0 23 4 0 2 15 5 101 6 6 ...
    ##   ..- attr(*, "dimnames")=List of 2
...
```
    ...
    ##   ..$ replication_1: num [1:105, 1:105] 0 24 4 0 2 16 4 103 5 8 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ replication_2: num [1:105, 1:105] 0 24 5 0 2 16 4 101 5 7 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ...
    ##   ..$ replication_1: num [1:105, 1:105] 0 54 2 0 0 39 2 76 5 7 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ replication_2: num [1:105, 1:105] 0 54 3 0 0 40 1 76 6 7 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ replication_3: num [1:105, 1:105] 0 56 2 0 0 39 1 77 5 7 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
...
```
    ...
    ## 1   parameter_1            0.05 replication_1 0.8158096 10.688965 0.12954745
    ## 2   parameter_1            0.05 replication_2 0.8156998 10.684217 0.12952647
    ## 3   parameter_1            0.05 replication_3 0.8155900 10.692011 0.12978906
    ## 4   parameter_2           0.055 replication_1 0.8308984  9.550330 0.11355693
    ## 5   parameter_2           0.055 replication_2 0.8308684  9.545094 0.11340699
    ## 6   parameter_2           0.055 replication_3 0.8309034  9.541245 0.11331787
    ## 7   parameter_3            0.06 replication_1 0.8430523  8.735163 0.09853202
    ## 8   parameter_3            0.06 replication_2 0.8430423  8.749276 0.09869890
    ## 9   parameter_3            0.06 replication_3 0.8430972  8.738008 0.09864686
    ## 10  parameter_4           0.065 replication_1 0.8513928  8.225154 0.08806009
    ## 11  parameter_4           0.065 replication_2 0.8513479  8.225244 0.08815364
    ## 12  parameter_4           0.065 replication_3 0.8514228  8.225575 0.08841278
    ## 13  parameter_5            0.07 replication_1 0.8548968  7.987561 0.08051549
    ## 14  parameter_5            0.07 replication_2 0.8550066  7.979738 0.08036695
    ## 15  parameter_5            0.07 replication_3 0.8548468  7.994079 0.08064963
    ## 16  parameter_6           0.075 replication_1 0.8554009  7.956051 0.07927801
    ## 17  parameter_6           0.075 replication_2 0.8553560  7.960988 0.07968485
    ## 18  parameter_6           0.075 replication_3 0.8555157  7.953752 0.07941258
    ## 19  parameter_7            0.08 replication_1 0.8548768  8.087880 0.07430826
    ## 20  parameter_7            0.08 replication_2 0.8548369  8.090766 0.07471902
    ## 21  parameter_7            0.08 replication_3 0.8548319  8.083088 0.07438685
    ## 22  parameter_8           0.085 replication_1 0.8530150  8.344071 0.07418524
    ## 23  parameter_8           0.085 replication_2 0.8530649  8.337147 0.07395411
    ## 24  parameter_8           0.085 replication_3 0.8529751  8.342786 0.07387503
    ## 25  parameter_9            0.09 replication_1 0.8500402  8.661799 0.07538999
    ## 26  parameter_9            0.09 replication_2 0.8499753  8.666814 0.07562720
    ## 27  parameter_9            0.09 replication_3 0.8498505  8.663693 0.07548605
    ## 28 parameter_10           0.095 replication_1 0.8464314  9.032256 0.08136423
    ## 29 parameter_10           0.095 replication_2 0.8465462  9.027012 0.08098375
    ## 30 parameter_10           0.095 replication_3 0.8465712  9.025450 0.08107065
    ## 31 parameter_11             0.1 replication_1 0.8424833  9.423752 0.08344035
    ## 32 parameter_11             0.1 replication_2 0.8423885  9.426066 0.08364609
    ## 33 parameter_11             0.1 replication_3 0.8423984  9.428851 0.08362341
    ##          CPL     CPC_d    KS_stat   KS_pval
    ## 1  0.6569953 0.8945280 0.07509471 0.9997318
    ## 2  0.6591133 0.8944881 0.07502483 0.9997367
    ## 3  0.6581281 0.8943832 0.07519454 0.9997248
    ## 4  0.6711583 0.9146830 0.05168533 1.0000000
    ## 5  0.6711618 0.9144335 0.05186002 1.0000000
    ## 6  0.6706462 0.9146231 0.05166536 1.0000000
    ## 7  0.6727862 0.9311095 0.03170000 1.0000000
    ## 8  0.6724231 0.9310546 0.03166007 1.0000000
    ## 9  0.6718834 0.9311045 0.03180981 1.0000000
    ## 10 0.6717300 0.9426495 0.03466985 1.0000000
    ## 11 0.6720989 0.9426545 0.03469480 1.0000000
    ## 12 0.6722878 0.9426944 0.03464988 1.0000000
    ## 13 0.6736597 0.9487090 0.03822867 1.0000000
    ## 14 0.6738623 0.9488338 0.03821869 1.0000000
    ## 15 0.6726902 0.9486391 0.03824864 1.0000000
    ## 16 0.6718891 0.9481899 0.04434806 1.0000000
    ## 17 0.6730885 0.9481300 0.04445287 1.0000000
    ## 18 0.6710764 0.9482797 0.04437800 1.0000000
    ## 19 0.6635745 0.9409225 0.05029773 1.0000000
    ## 20 0.6631612 0.9409375 0.05038758 1.0000000
    ## 21 0.6625387 0.9409824 0.05034266 1.0000000
    ## 22 0.6522568 0.9329913 0.05738044 1.0000000
    ## 23 0.6518424 0.9331061 0.05730557 1.0000000
    ## 24 0.6505564 0.9330262 0.05742537 1.0000000
    ## 25 0.6404421 0.9257888 0.06330017 0.9999988
    ## 26 0.6421839 0.9258187 0.06326024 0.9999988
    ## 27 0.6408840 0.9259036 0.06322031 0.9999989
    ## 28 0.6369343 0.9189456 0.06813179 0.9999913
    ## 29 0.6346472 0.9189007 0.06815675 0.9999912
    ## 30 0.6353097 0.9189007 0.06816673 0.9999912
    ## 31 0.6242383 0.9122123 0.07353242 0.9999476
    ## 32 0.6233503 0.9121175 0.07355738 0.9999472
    ## 33 0.6235613 0.9122572 0.07345755 0.9999488
