...
```
    ...
    ##  $ replication_1: num [1:105, 1:105] 0 23 4 0 2 16 4 102 5 6 ...
    ##   ..- attr(*, "dimnames")=List of 2
    ##  $ replication_2: num [1:105, 1:105] 0 24 4 0 3 15 4 101 5 7 ...
    ##   ..- attr(*, "dimnames")=List of 2
    ##  $ replication_3: num [1:105, 1:105] 0 23 4 0 3 15 4 102 5 7 ...
    ##   ..- attr(*, "dimnames")=List of 2
...
```
    ...
    ##   ..$ replication_1: num [1:105, 1:105] 0 24 4 0 2 15 4 101 6 9 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ replication_2: num [1:105, 1:105] 0 24 4 0 2 16 4 103 6 8 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ replication_3: num [1:105, 1:105] 0 23 4 1 2 17 5 102 7 6 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ proba        : num [1:105, 1:105] 0.00 4.31e-05 2.16e-05 3.90e-06 1.81e-05 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##  $ parameter_2:List of 4
    ##   ..$ replication_1: num [1:105, 1:105] 0 54 2 0 0 39 1 76 5 8 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ replication_2: num [1:105, 1:105] 0 55 2 0 0 40 1 77 5 7 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
    ##   ..$ replication_3: num [1:105, 1:105] 0 53 2 0 0 39 1 76 5 7 ...
    ##   .. ..- attr(*, "dimnames")=List of 2
...
```
    ...
    ##  [1,]    0   33    0    0    0  120    0    1    0     0
    ##  [2,]  573    0    0    0    0   22    0    0    0     0
    ##  [3,]    0    0    0    0    0    0  200    0    0     0
...
```
    ...
    ## 1   parameter_1            0.05 replication_1 0.8157397 10.690692 0.12943992
    ## 2   parameter_1            0.05 replication_2 0.8157846 10.688984 0.12959700
    ## 3   parameter_1            0.05 replication_3 0.8156249 10.692054 0.12963313
    ## 4   parameter_2           0.055 replication_1 0.8309483  9.542816 0.11354108
    ## 5   parameter_2           0.055 replication_2 0.8307337  9.547329 0.11362835
    ## 6   parameter_2           0.055 replication_3 0.8307786  9.545382 0.11344729
    ## 7   parameter_3            0.06 replication_1 0.8431921  8.735910 0.09842926
    ## 8   parameter_3            0.06 replication_2 0.8431571  8.735579 0.09841884
    ## 9   parameter_3            0.06 replication_3 0.8429625  8.737221 0.09864933
    ## 10  parameter_4           0.065 replication_1 0.8512780  8.232138 0.08812379
    ## 11  parameter_4           0.065 replication_2 0.8514028  8.220617 0.08808022
    ## 12  parameter_4           0.065 replication_3 0.8512830  8.228784 0.08832748
    ## 13  parameter_5            0.07 replication_1 0.8550016  7.983499 0.08063045
    ## 14  parameter_5            0.07 replication_2 0.8549017  7.995033 0.08051767
    ## 15  parameter_5            0.07 replication_3 0.8551014  7.982933 0.08013540
    ## 16  parameter_6           0.075 replication_1 0.8554757  7.955300 0.08010477
    ## 17  parameter_6           0.075 replication_2 0.8553659  7.961737 0.07947956
    ## 18  parameter_6           0.075 replication_3 0.8554458  7.953795 0.07936661
    ## 19  parameter_7            0.08 replication_1 0.8548219  8.090076 0.07438393
    ## 20  parameter_7            0.08 replication_2 0.8548369  8.089601 0.07434470
    ## 21  parameter_7            0.08 replication_3 0.8548868  8.089951 0.07532760
    ## 22  parameter_8           0.085 replication_1 0.8530799  8.334038 0.07385292
    ## 23  parameter_8           0.085 replication_2 0.8530999  8.340651 0.07414468
    ## 24  parameter_8           0.085 replication_3 0.8530050  8.339793 0.07405058
    ## 25  parameter_9            0.09 replication_1 0.8499703  8.659627 0.07533256
    ## 26  parameter_9            0.09 replication_2 0.8498755  8.662661 0.07548205
    ## 27  parameter_9            0.09 replication_3 0.8499553  8.658751 0.07531803
    ## 28 parameter_10           0.095 replication_1 0.8464913  9.031246 0.08122906
    ## 29 parameter_10           0.095 replication_2 0.8464814  9.024913 0.08105875
    ## 30 parameter_10           0.095 replication_3 0.8465562  9.026581 0.08090840
    ## 31 parameter_11             0.1 replication_1 0.8425082  9.425661 0.08367887
    ## 32 parameter_11             0.1 replication_2 0.8423435  9.426331 0.08366422
    ## 33 parameter_11             0.1 replication_3 0.8423785  9.426320 0.08400876
    ##          CPL     CPC_d    KS_stat   KS_pval
    ## 1  0.6579660 0.8943982 0.07506975 0.9997335
    ## 2  0.6587830 0.8944831 0.07502982 0.9997363
    ## 3  0.6576355 0.8944481 0.07508473 0.9997324
    ## 4  0.6704693 0.9145483 0.05180013 1.0000000
    ## 5  0.6702927 0.9145982 0.05180013 1.0000000
    ## 6  0.6697771 0.9147180 0.05160047 1.0000000
    ## 7  0.6715250 0.9311894 0.03159019 1.0000000
    ## 8  0.6724184 0.9312293 0.03166506 1.0000000
    ## 9  0.6727812 0.9310247 0.03179484 1.0000000
    ## 10 0.6711636 0.9426196 0.03472974 1.0000000
    ## 11 0.6711598 0.9427244 0.03467484 1.0000000
    ## 12 0.6722878 0.9425048 0.03470978 1.0000000
    ## 13 0.6750292 0.9487988 0.03823366 1.0000000
    ## 14 0.6736658 0.9487889 0.03818874 1.0000000
    ## 15 0.6738497 0.9487539 0.03821370 1.0000000
    ## 16 0.6734694 0.9482997 0.04439298 1.0000000
    ## 17 0.6708785 0.9481949 0.04443790 1.0000000
    ## 18 0.6714801 0.9482997 0.04436802 1.0000000
    ## 19 0.6629526 0.9410373 0.05030272 1.0000000
    ## 20 0.6643963 0.9409175 0.05030772 1.0000000
    ## 21 0.6631612 0.9409674 0.05031271 1.0000000
    ## 22 0.6514140 0.9330112 0.05736048 1.0000000
    ## 23 0.6511924 0.9331011 0.05725566 1.0000000
    ## 24 0.6505564 0.9330512 0.05735050 1.0000000
    ## 25 0.6404677 0.9258586 0.06326523 0.9999988
    ## 26 0.6404677 0.9258037 0.06321033 0.9999989
    ## 27 0.6413255 0.9257937 0.06323529 0.9999989
    ## 28 0.6357616 0.9189307 0.06817172 0.9999912
    ## 29 0.6350993 0.9188558 0.06818670 0.9999911
    ## 30 0.6357616 0.9188408 0.06813678 0.9999913
    ## 31 0.6240271 0.9122323 0.07349748 0.9999482
    ## 32 0.6247039 0.9121724 0.07359232 0.9999466
    ## 33 0.6254226 0.9122473 0.07354240 0.9999474
